...
//added by WangChengQing
#include "..\服务核心\WHDataQueue.h"
...
enum enTraceLevel
{
	TraceLevel_Debug				=0,									//调试消息
	TraceLevel_Info					=1,									//信息消息
	TraceLevel_Normal				=2,									//普通消息
	TraceLevel_Warning				=3,									//警告消息
	TraceLevel_Exception			=4,									//异常消息
};
...
#ifdef _UNICODE
	#define VER_IDataBaseException INTERFACE_VERSION(CODE_VERSION,KERNEL_VERSION)
...
#ifdef _UNICODE
	#define VER_ITraceService INTERFACE_VERSION(CODE_VERSION,KERNEL_VERSION)
...
interface ITraceService : public IUnknownEx
{
	...
	virtual bool EnableTrace(enTraceLevel TraceLevel,enTraceLevel TraceLevelToOut, LPCTSTR pszFileName = NULL)=NULL;
};

//////////////////////////////////////////////////////////////////////////////////

#ifdef _UNICODE
	#define VER_ITraceServiceManager INTERFACE_VERSION(CODE_VERSION,KERNEL_VERSION)
...
#ifdef _UNICODE
	#define VER_IServiceModule INTERFACE_VERSION(CODE_VERSION,KERNEL_VERSION)
...
#ifdef _UNICODE
	#define VER_IAsynchronismEngine INTERFACE_VERSION(CODE_VERSION,KERNEL_VERSION)
...
#ifdef _UNICODE
	#define VER_IAsynchronismEngineSink INTERFACE_VERSION(CODE_VERSION,KERNEL_VERSION)
...
#ifdef _UNICODE
	#define VER_IDataBase INTERFACE_VERSION(CODE_VERSION,KERNEL_VERSION)
...
#ifdef _UNICODE
	#define VER_IDataBaseEngine INTERFACE_VERSION(CODE_VERSION,KERNEL_VERSION)
...
#ifdef _UNICODE
	#define VER_IDataBaseEngineSink INTERFACE_VERSION(CODE_VERSION,KERNEL_VERSION)
...
#ifdef _UNICODE
	#define VER_IUDPNetworkEngine INTERFACE_VERSION(CODE_VERSION,KERNEL_VERSION)
...
#ifdef _UNICODE
	#define VER_ITCPNetworkEngine INTERFACE_VERSION(CODE_VERSION,KERNEL_VERSION)
...
public:
	...
	//设置参数
	virtual bool SetServiceParameter(WORD wServicePort, WORD wMaxConnect, BOOL bEncrypt)=NULL;
...
#ifdef _UNICODE
	#define VER_ITCPSocketService INTERFACE_VERSION(CODE_VERSION,KERNEL_VERSION)
...
public:
	...
	//加密配置
	virtual bool SetEncrypt(BOOL bEncrypt)=NULL;
	//设置接口
...
#ifdef _UNICODE
	#define VER_IWEBSocketService INTERFACE_VERSION(CODE_VERSION,KERNEL_VERSION)
...
#ifdef _UNICODE
	#define VER_ITimerEngine INTERFACE_VERSION(CODE_VERSION,KERNEL_VERSION)
...
#ifdef _UNICODE
	#define VER_ITimerEngineEvent INTERFACE_VERSION(CODE_VERSION,KERNEL_VERSION)
...
#ifdef _UNICODE
	#define VER_IDataBaseEngineEvent INTERFACE_VERSION(CODE_VERSION,KERNEL_VERSION)
...
#ifdef _UNICODE
	#define VER_ITCPSocketEvent INTERFACE_VERSION(CODE_VERSION,KERNEL_VERSION)
...
#ifdef _UNICODE
	#define VER_IWEBSocketEvent INTERFACE_VERSION(CODE_VERSION,KERNEL_VERSION)
...
#ifdef _UNICODE
	#define VER_ITCPNetworkEngineEvent INTERFACE_VERSION(CODE_VERSION,KERNEL_VERSION)
...
#ifdef _UNICODE
	#define VER_IAttemperEngine INTERFACE_VERSION(CODE_VERSION,KERNEL_VERSION)
...
#ifdef _UNICODE
	#define VER_IAttemperEngineSink INTERFACE_VERSION(CODE_VERSION,KERNEL_VERSION)
