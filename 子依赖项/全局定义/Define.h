...
#define LEN_GAME                    128                                 //游戏长度
#define LEN_SERVER					32									//房间长度
#define LEN_DLL                     32                                  //DLL长度
#define LEN_PROCESS					32									//进程长度 TODONOW？？？

#define LEN_IP_ADDR                 32                                  //IP地址长度
//数据库相关
#define LEN_DB_ADDR					32									//地址长度 TODONOW应改回16
#define LEN_DB_NAME					32									//名字长度
#define LEN_DB_USER					32									//账号长度
#define LEN_DB_PASS					32									//密码长度
#define LEN_DB_USER_MD				512									//账号长度 加密后
#define LEN_DB_PASS_MD				512									//密码长度 加密后
