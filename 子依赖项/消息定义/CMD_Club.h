...
#define CMD_GC_CLUB_TABLE_LIST_TABLE_FINISH		216							//请求该房间的桌子信息 完成

#define SUB_CG_CLUB_CREATE_TABLE				17							//创建桌子 
#define CMD_GC_CLUB_CREATE_TABKE				117							//创建桌子 返回

#define SUB_CG_CLUB_JOIN_TABLE_NO_PASS			19							//#加入桌子,不需要密码, 即快速开始 -- 仅牌友群使用
...
#define CMD_LC_CLUB_DATA						231							//工会基本信息
...
#define CMD_LC_CLUB_RECORD_LIST_FINISH			241							//工会战绩统计 结束
#pragma endregion
