...
#ifndef SUB_INCLUDE_IMPORT_FILES
	//消息定义
...
public:
	...
	//获取定时器剩余毫秒数
	virtual DWORD GetTimerLeftTickCount(UINT dwTimerID)=NULL;
	//发送准备
...
public:
	...
	//用户比赛成绩
	virtual bool  OnUserMatchResult(DWORD dwUserID, WORD wKindID, DWORD wServerID, WORD wSortID)=NULL;
	//获取比赛信息
